...
# ═══════════════════════════════════════════════════════════════════
# STOP_COMMAND — 批量窗口"停止"按钮发送的命令
# ═══════════════════════════════════════════════════════════════════
# 只影响【批量测试窗口的"停止"按钮】。
# 主窗口"停止测试"、关闭窗口等其他路径不受影响。
#
# 可选值：
#   "disconnect" → 发 00 00 00 00 00 00 00 00（退出PC，设备回待机）
#                  —— 默认，推荐
#   "reset"      → 发 01 00 00 00 00 00 00 00（复位，设备保持 PC 就绪）
#   "none"       → 什么都不发（纯软件停止，用于调试）
#
# 改这一个值即可切换，重启程序生效。
# ═══════════════════════════════════════════════════════════════════
